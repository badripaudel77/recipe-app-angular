...
export class RecipesListComponent implements OnInit {
  ...
  recipes: RecipeModel[] = [
      ...
      new RecipeModel('Another 2 name', 'Another 2 Desc', 'https://images.pexels.com/photos/3806983/pexels-photo-3806983.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')
  ];
